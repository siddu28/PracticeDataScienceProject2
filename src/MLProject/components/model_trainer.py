...
from src.MLProject.utils.common import evaluate_model
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_arr,test_arr):
        ...
        logger.info("Entered Model Trainer.....")
        try:
            ...
            logger.info("best found model on both training and testing datset")
